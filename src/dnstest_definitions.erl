...
erldns_definitions() ->
    [
        ...
        {cname_wildcard_cover, {
            ...
            {records, {
                {answers, [
                    {<<"www.cover.wtest.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 3600, #dns_rrdata_cname{
...
erldns_dnssec_definitions() ->
    [
        {dnssec_soa, {
            ...
            {records, {
                {answers, [
                    ...
                    {<<"minimal-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_SOA,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 2,
                        original_ttl = 120,
                        expiration = ?TEST_REPLACE,
                        inception = ?TEST_REPLACE,
                        key_tag = ?TEST_REPLACE,
                        signers_name = <<"minimal-dnssec.com">>,
                        signature = ?TEST_REPLACE
                    }}
                ]},
                {authority, []},
                {additional, []}
        ...
        {dnssec_a, {
            ...
            {records, {
                {answers, [
                    ...
                    {<<"outpost.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        ...
                        inception = ?TEST_REPLACE,
                        key_tag = ?TEST_REPLACE,
                        signers_name = <<"example-dnssec.com">>,
                        signature = ?TEST_REPLACE
                    }}
                ]},
                {authority, []},
        ...
        {dnssec_cname, {
            ...
            {records, {
                {answers, [
                    {<<"www.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
                        dname = <<"outpost.example-dnssec.com">>
                    }},
                    {<<"www.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
            ...
            {records, {
                {answers, [
                    {<<"example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CDS, 120, #dns_rrdata_cds{
                        ...
                        digest_type = 2,
                        digest =
                            <<67, 21, 167, 173, 9, 174, 11, 235, 166, 204, 49, 4, 187, 205, 136, 0, 14, 215, 150, 136, 127, 28, 77, 82, 10,
                                58, 96, 141, 113, 91, 114, 202>>
                    }},
                    {<<"example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
        ...
        {dnssec_cdnskey, {
            ...
            {records, {
                {answers, [
                    {<<"example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CDNSKEY, 120, #dns_rrdata_cdnskey{
                        flags = 256,
                        protocol = 3,
                        alg = ?DNS_ALG_RSASHA256,
                        public_key = [
                            14035071367807743739426074910541039401557049548824177782635168692110322779944732953326230489581646087318994485815085,
        ...
        {dnssec_dnskey, {
            ...
            {records, {
                {answers, [
                    {<<"example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_DNSKEY, 120, #dns_rrdata_dnskey{
                        flags = 257, protocol = 3, alg = ?DNS_ALG_RSASHA256, public_key = ?TEST_REPLACE, key_tag = ?TEST_REPLACE
                    }},
                    {<<"example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_DNSKEY, 120, #dns_rrdata_dnskey{
                        flags = 256, protocol = 3, alg = ?DNS_ALG_RSASHA256, public_key = ?TEST_REPLACE, key_tag = ?TEST_REPLACE
                    }},
                    {<<"example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
        ...
        {nsec_name, {
            ...
            {records, {
                ...
                {authority, [
                    ...
                    {<<"a.minimal-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_NSEC, 86400, #dns_rrdata_nsec{
                        next_dname = <<"\000.a.minimal-dnssec.com">>, types = [?DNS_TYPE_RRSIG, ?DNS_TYPE_NSEC]
                    }},
                    {<<"a.minimal-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 86400, #dns_rrdata_rrsig{
        ...
        {nsec_type, {
            ...
            {records, {
                ...
                {authority, [
                    ...
                    {<<"minimal-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_NSEC, 86400, #dns_rrdata_nsec{
                        next_dname = <<"\000.minimal-dnssec.com">>,
                        types = [?DNS_TYPE_NS, ?DNS_TYPE_SOA, ?DNS_TYPE_RRSIG, ?DNS_TYPE_NSEC, ?DNS_TYPE_DNSKEY]
                    }},
                    {<<"minimal-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 86400, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_NSEC,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 2,
                        original_ttl = 86400,
        ...
        {nsec_type_any, {
            ...
            {records, {
                {answers, [
                    ...
                    {<<"minimal-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_DNSKEY, 120, #dns_rrdata_dnskey{
                        flags = 256, protocol = 3, alg = ?DNS_ALG_RSASHA256, public_key = ?TEST_REPLACE, key_tag = ?TEST_REPLACE
                    }},
                    {<<"minimal-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_DNSKEY, 120, #dns_rrdata_dnskey{
                        flags = 257, protocol = 3, alg = ?DNS_ALG_RSASHA256, public_key = ?TEST_REPLACE, key_tag = ?TEST_REPLACE
        ...
        {nsec_rr_type_bitmap_wildcard, {
            ...
            {records, {
                ...
                {authority, [
                    ...
                    {<<"example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 86400, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_SOA,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 2,
                        original_ttl = 120,
                    ...
                    {<<"nosuch.wildcard-aaaa.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_NSEC, 86400, #dns_rrdata_nsec{
                        next_dname = <<"\000.nosuch.wildcard-aaaa.example-dnssec.com">>,
                        types = [?DNS_TYPE_RRSIG, ?DNS_TYPE_NSEC, ?DNS_TYPE_A]
                    }},
                    {<<"nosuch.wildcard-aaaa.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 86400, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_NSEC,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 2,
                        original_ttl = 120,
        ...
        {cname_to_nxdomain_dnssec, {
            ...
            {records, {
                {answers, [
                    {<<"nxd.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
                        dname = <<"nxdomain.example-dnssec.com">>
                    }},
                    {<<"nxd.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_CNAME,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 3,
                        original_ttl = 120,
                ...
                {authority, [
                    {<<"example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_SOA, 86400, #dns_rrdata_soa{
                        mname = <<"ns1.example-dnssec.com">>,
                        rname = <<"ahu.example-dnssec.com">>,
                        serial = 2000081501,
                        refresh = 28800,
                        retry = 7200,
                        expire = 604800,
        ...
        {cname_wildcard_chain_dnssec, {
            ...
            {records, {
                {answers, [
                    {<<"start.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
                        dname = <<"x.y.z.w1.example-dnssec.com">>
                    }},
                    {<<"start.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_CNAME,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 3,
                        original_ttl = 120,
                    ...
                    {<<"x.y.z.w1.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
                        dname = <<"x.y.z.w2.example-dnssec.com">>
                    }},
                    {<<"x.y.z.w1.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_CNAME,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 6,
                        original_ttl = 120,
                    ...
                    {<<"x.y.z.w2.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
                        dname = <<"x.y.z.w3.example-dnssec.com">>
                    }},
                    {<<"x.y.z.w2.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_CNAME,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 6,
                        original_ttl = 120,
                    ...
                    {<<"x.y.z.w3.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
                        dname = <<"x.y.z.w4.example-dnssec.com">>
                    }},
                    {<<"x.y.z.w3.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_CNAME,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 6,
                        original_ttl = 120,
                    ...
                    {<<"x.y.z.w4.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
                        dname = <<"x.y.z.w5.example-dnssec.com">>
                    }},
                    {<<"x.y.z.w4.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_CNAME,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 6,
                        original_ttl = 120,
                    ...
                    {<<"x.y.z.w5.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_A,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 6,
                        original_ttl = 120,
...
pdns_dnssec_definitions() ->
    [
        ...
        {cname_to_unauth_any_dnssec, {
            ...
            {records, {
                {answers, [
                    {<<"unauth.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
                        dname = <<"no-idea.example.org">>
                    }},
                    {<<"unauth.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_CNAME,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 3,
                        original_ttl = 120,
        ...
        {double_dnssec, {
            ...
            {records, {
                {answers, [
                    ...
                    {<<"double.example-dnssec.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_RRSIG, 120, #dns_rrdata_rrsig{
                        type_covered = ?DNS_TYPE_A,
                        alg = ?DNS_ALG_RSASHA256,
                        labels = 3,
                        original_ttl = 120,
...
pdns_definitions() ->
    [
        ...
        {basic_srv_resolution, {
            ...
            {records, {
                {answers, [
                    {<<"_ldap._tcp.dc.test.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_SRV, 3600, #dns_rrdata_srv{
                        priority = 0, weight = 100, port = 389, target = <<"server2.example.net">>
                    }}
                ]},
                {authority, []},
                {additional, []}
        ...
        {cname_to_referral, {
            ...
            {records, {
                {answers, [
                    {<<"server1.example.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
        ...
        {cross_domain_cname_to_wildcard, {
            ...
            {records, {
                {answers, [
                    {<<"semi-external.example.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_CNAME, 120, #dns_rrdata_cname{
        ...
        {double_srv, {
            ...
            {records, {
                {answers, [
                    {<<"_double._tcp.dc.test.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_SRV, 3600, #dns_rrdata_srv{
        ...
        {multi_txt_escape_resolution, {
            ...
            {records, {
                {answers, [
                    {<<"escapedtext.example.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_TXT, 120, #dns_rrdata_txt{
        ...
        {multi_txt_resolution, {
            ...
            {records, {
                {answers, [
                    {<<"multitext.example.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_TXT, 120, #dns_rrdata_txt{
        ...
        {root_srv, {
            ...
            {records, {
                {answers, [
                    {<<"_root._tcp.dc.test.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_SRV, 3600, #dns_rrdata_srv{
        ...
        {too_big_for_udp_query_no_truncate_additional, {
            ...
            {records, {
                {answers, [
                    {<<"together-too-much.example.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_MX, 120, #dns_rrdata_mx{
        ...
        {very_long_text, {
            ...
            {records, {
                {answers, [
                    {<<"very-long-txt.test.com">>, ?DNS_CLASS_IN, ?DNS_TYPE_TXT, 3600, #dns_rrdata_txt{
                        txt = [
